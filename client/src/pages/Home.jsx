    ...
    <>
      <div className="flex justify-center align-middle">
        <table className="table w-1/2">
          ...
          <tfoot>
          {listOfEquipment == 0 ? 
          <div className="text-2xl absolute mx-auto w-full font-bold text-teal-500 flex align-middle justify-center p-20 border-solid border-teal-500 border-2">
